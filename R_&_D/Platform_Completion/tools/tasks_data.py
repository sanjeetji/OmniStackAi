...
QUEUE = [
    ...
    ("PC-017", "Pack framework: manifest v2, composer, horizontal and vertical packs, "
     "blueprints", "2 Maximum features", "Both", "Not Started", "P2", "R-572",
     "From specs/pack-framework 01-05, 06b, 06c, 06e."),
...
OTHER = [
    ...
    ("SPEC-PACK-01", "Pack manifest v2 schema", "specs/pack-framework/01", N, "P2", "PC-017",
     "Draft spec (called R-600 inside)."),
    ("SPEC-PACK-02", "Pack composer: merge, wire, validate", "specs/pack-framework/02", N, "P2",
     "PC-017", "Draft spec."),
    ("SPEC-PACK-03", "Horizontal packs registry (30 packs)", "specs/pack-framework/03", N, "P2",
     "PC-017", "Draft spec."),
    ("SPEC-PACK-04", "MVP vertical packs (first 10)", "specs/pack-framework/04", N, "P2",
     "PC-017", "Draft spec."),
    ("SPEC-PACK-05", "Blueprint structure and template-to-blueprint conversion",
     "specs/pack-framework/05", N, "P2", "PC-017", "Draft spec."),
    ("SPEC-PACK-06A", "State machine codegen", "specs/pack-framework/06a", S, "", "R-566",
     "Delivered by R-566, R-588, R-589."),
    ("SPEC-PACK-06B", "Role-based app generator", "specs/pack-framework/06b", P, "P2", "PC-017",
     "R-555 and R-562 build one app per role; the spec asks for more."),
    ("SPEC-PACK-06C", "Page template engine", "specs/pack-framework/06c", N, "P2", "PC-017",
     "Draft spec."),
    ("SPEC-PACK-06D", "Shared package generator", "specs/pack-framework/06d", N, "P1", "R-572",
     "Draft spec."),
    ("SPEC-PACK-06E", "Rich seed data generator", "specs/pack-framework/06e", P, "P2", "PC-017",
