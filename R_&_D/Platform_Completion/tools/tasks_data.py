...
QUEUE = [
    ...
    ("PC-073", "Horizontal packs registry: all 31 universal packs as manifest v2 packs that "
     "work alone and compose (HP-* rows)", "2 Maximum features", "Both", "Pending", "P1",
     "PC-017", "Each pack packages a capability built by its own task; core 10 first "
     "(auth, db, api, design, admin, payments, notifications, files, realtime, workflows). "
     "From specs/pack-framework/03."),
    ("PC-074", "Vertical packs: the first 10 domains (VP-* rows)", "2 Maximum features", "Both",
     "Pending", "P1", "PC-073, PC-072", "Healthcare, mobility and commerce come from the "
     "three templates; seven are new. From specs/pack-framework/04."),
...
OTHER = [
    ...
    ("HP-auth-rbac", "Horizontal pack auth-rbac: Login, register, roles, permissions, JWT, sessions, passkeys",
     "specs/pack-framework/03", P, "P1", "PC-073", "Auth exists (R-461, R-241..R-243, R-591 for Go); passkeys new."),
    ("HP-payments", "Horizontal pack payments: Stripe/Razorpay checkout, webhooks, subscriptions, invoices, refunds",
     "specs/pack-framework/03", P, "P1", "PC-073", "Checkout exists (R-512); ledger/refunds R-567."),
    ("HP-notifications", "Horizontal pack notifications: Email/SMS/push, templates, preferences, in-app centre, digest",
     "specs/pack-framework/03", P, "P1", "PC-073", "Email exists (R-516); rest PC-053."),
    ("HP-files-storage", "Horizontal pack files-storage: S3 presigned uploads, progress, preview, PDF generation, CDN",
     "specs/pack-framework/03", N, "P1", "PC-073", "PC-052."),
    ("HP-search", "Horizontal pack search: Meilisearch/Typesense, facets, saved searches, synonyms",
     "specs/pack-framework/03", P, "P3", "PC-073", "Keyword search exists (R-261); engine PC-058."),
    ("HP-real-time", "Horizontal pack real-time: Presence, live updates, typing indicators",
     "specs/pack-framework/03", N, "P1", "PC-073", "R-569."),
    ("HP-workflows", "Horizontal pack workflows: State machine engine: transitions, guards, actions, audit",
     "specs/pack-framework/03", P, "P1", "PC-073", "Transitions done (R-566, R-588, R-589); guards/actions R-571; buttons R-590."),
    ("HP-admin-crud", "Horizontal pack admin-crud: Generated admin: tables, filters, bulk actions, audit log, exports",
     "specs/pack-framework/03", P, "P1", "PC-073", "Admin app exists (R-542, R-270, R-271)."),
    ("HP-multi-app", "Horizontal pack multi-app: Shared API, cross-app auth, preview proxy, deploy coordination",
     "specs/pack-framework/03", P, "P1", "PC-073", "Ecosystem monorepo exists (R-554, R-447, R-553)."),
    ("HP-audit-compliance", "Horizontal pack audit-compliance: Immutable audit log, GDPR export, retention, lineage",
     "specs/pack-framework/03", N, "P2", "PC-073", "PC-057, PC-012."),
    ("HP-analytics", "Horizontal pack analytics: Event tracking, PostHog/GA4/Mixpanel, dashboards, funnels",
     "specs/pack-framework/03", P, "P2", "PC-073", "Published-app analytics exists (R-513)."),
    ("HP-scheduling", "Horizontal pack scheduling: Calendars, recurrence, conflicts, time zones, bookings, reminders",
     "specs/pack-framework/03", N, "P1", "PC-073", "New pack; reminders need R-568."),
    ("HP-communications", "Horizontal pack communications: Chat, comments, mentions, threads, attachments, reactions",
     "specs/pack-framework/03", N, "P2", "PC-073", "New pack; needs R-569."),
    ("HP-ratings-reviews", "Horizontal pack ratings-reviews: Stars, reviews, moderation, aggregates, helpful votes",
     "specs/pack-framework/03", N, "P2", "PC-073", "New pack."),
    ("HP-referrals-affiliates", "Horizontal pack referrals-affiliates: Codes, tracking, rewards, payouts",
     "specs/pack-framework/03", N, "P3", "PC-073", "New pack; payouts need R-567."),
    ("HP-subscriptions", "Horizontal pack subscriptions: Plans, trials, up/downgrades, proration, dunning",
     "specs/pack-framework/03", N, "P2", "PC-073", "R-567."),
    ("HP-marketplace-core", "Horizontal pack marketplace-core: Two-sided matching, commissions, payouts, disputes, escrow",
     "specs/pack-framework/03", N, "P2", "PC-073", "R-567; Bazaar template shows the shape."),
    ("HP-localization", "Horizontal pack localization: i18n, RTL, currency, date/number formatting",
     "specs/pack-framework/03", N, "P2", "PC-073", "PC-055."),
    ("HP-feature-flags", "Horizontal pack feature-flags: Rollouts, targeting, experiments, kill switches",
     "specs/pack-framework/03", N, "P3", "PC-073", "PC-056."),
    ("HP-api-docs", "Horizontal pack api-docs: OpenAPI, Swagger UI, Postman collection, SDKs",
     "specs/pack-framework/03", P, "P2", "PC-073", "OpenAPI exists (R-260, R-588)."),
    ("HP-rbac-advanced", "Horizontal pack rbac-advanced: ABAC, resource-level permissions, org hierarchies, impersonation",
     "specs/pack-framework/03", N, "P1", "PC-073", "R-570."),
    ("HP-webhooks", "Horizontal pack webhooks: Outgoing webhooks, retry, signatures, dead letter",
     "specs/pack-framework/03", N, "P2", "PC-073", "PC-057."),
    ("HP-cache", "Horizontal pack cache: Redis/Valkey, invalidation",
     "specs/pack-framework/03", N, "P3", "PC-073", "New pack."),
    ("HP-queue", "Horizontal pack queue: Background jobs, dead letter, priority, scheduling",
     "specs/pack-framework/03", N, "P1", "PC-073", "R-568."),
    ("HP-secrets", "Horizontal pack secrets: Env/Vault management, rotation, audit",
     "specs/pack-framework/03", P, "P2", "PC-073", "Platform secrets exist (R-503); generated-app side new."),
    ("HP-observability", "Horizontal pack observability: OpenTelemetry, logs, metrics, traces, Sentry, alerting",
     "specs/pack-framework/03", N, "P2", "PC-073", "PC-057."),
    ("HP-testing", "Horizontal pack testing: Playwright E2E, contract, visual regression",
     "specs/pack-framework/03", N, "P1", "PC-073", "PC-054."),
    ("HP-storybook", "Horizontal pack storybook: Component docs, visual tests, design playground",
     "specs/pack-framework/03", N, "P3", "PC-073", "New pack."),
    ("HP-pwa", "Horizontal pack pwa: Service worker, offline, push, background sync",
     "specs/pack-framework/03", P, "P0", "PC-073", "R-573."),
    ("HP-accessibility", "Horizontal pack accessibility: WCAG 2.1 AA, axe-core automated checks",
     "specs/pack-framework/03", P, "P2", "PC-073", "Generated UI is accessible (R-296); automated axe checks new."),
    ("HP-performance", "Horizontal pack performance: Bundle analysis, Core Web Vitals, Lighthouse CI",
     "specs/pack-framework/03", N, "P2", "PC-073", "PC-037."),
    ("VP-healthcare-core", "Vertical pack healthcare-core: Patients, providers, appointments, EMR, telehealth, prescriptions, labs",
     "specs/pack-framework/04", P, "P1", "PC-074", "From the CareClinic template (PC-072)."),
    ("VP-mobility-core", "Vertical pack mobility-core: Rides, drivers, dispatch, routing, surge, earnings",
     "specs/pack-framework/04", P, "P1", "PC-074", "From the RideNow template (PC-072)."),
    ("VP-commerce-core", "Vertical pack commerce-core: Listings, cart, checkout, inventory, fulfilment, vendors, commissions",
     "specs/pack-framework/04", P, "P1", "PC-074", "From the Bazaar template (PC-072)."),
    ("VP-fintech-core", "Vertical pack fintech-core: Accounts, ledger, transfers, KYC, cards, lending, compliance",
     "specs/pack-framework/04", N, "P2", "PC-074", "Needs R-567; showcase template TPL-POCKET."),
    ("VP-food-delivery-core", "Vertical pack food-delivery-core: Restaurants, menus, orders, kitchen, couriers, dark stores",
     "specs/pack-framework/04", N, "P2", "PC-074", "Showcase template TPL-FRESHCART."),
    ("VP-real-estate-core", "Vertical pack real-estate-core: Properties, listings, tours, offers, contracts, escrow",
     "specs/pack-framework/04", N, "P2", "PC-074", "Showcase template TPL-ESTATELY."),
    ("VP-edtech-core", "Vertical pack edtech-core: Courses, enrolments, assignments, grades, certificates, video",
     "specs/pack-framework/04", N, "P2", "PC-074", "Showcase template TPL-LEARNHUB."),
    ("VP-saas-b2b-core", "Vertical pack saas-b2b-core: Orgs, teams, seats, entitlements, SSO, usage metering",
     "specs/pack-framework/04", N, "P2", "PC-074", "New."),
    ("VP-logistics-core", "Vertical pack logistics-core: Shipments, warehouses, tracking, route optimisation, customs",
     "specs/pack-framework/04", N, "P2", "PC-074", "Also fixes 'a logistics prompt yields one app' with R-580."),
    ("VP-hr-core", "Vertical pack hr-core: Hiring, onboarding, payroll, performance, attendance",
     "specs/pack-framework/04", N, "P3", "PC-074", "New."),
    ("VP-REMAINING", "About 70 further vertical packs (the architecture plan's ~80 total)",
     "docs/ARCHITECTURE_MASTER_PLAN.md §5.1", D, "P3", "",
     "After launch, one domain at a time, driven by what users build."),
]
