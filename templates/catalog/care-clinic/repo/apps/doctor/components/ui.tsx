...
export function Stat({
  ...
  const accent = {
    ...
    signal: "text-[var(--color-emerald-brand)]",
  }[tone];
...
export function Button({
  ...
  const look = {
    primary: "bg-[var(--color-emerald-brand)] text-white hover:bg-[var(--color-emerald-dark)]",
    ...
    ghost: "text-[var(--color-emerald-brand)] hover:bg-[var(--color-emerald-soft)]",
  }[variant];
...
export const inputClass =
  "w-full rounded-md border border-[var(--color-border-strong)] bg-white px-2.5 py-1.5 text-[13px] text-[var(--color-ink)] outline-none placeholder:text-[var(--color-ink-subtle)] focus:border-[var(--color-emerald-brand)] focus:ring-2 focus:ring-emerald-100";
