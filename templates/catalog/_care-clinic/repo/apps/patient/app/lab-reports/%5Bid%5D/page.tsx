    ...
    async function loadReport() {
      try {
        ...
        setOrder({
          ...
          status: "completed",
          clinical_indication: "Annual cardiovascular lipid evaluation and fasting blood sugar workup.",
        ...
        setItems([
          ...
          },
          {
            ...
            unit: "mg/dL",
            is_abnormal: false,
            remarks: "Optimal protective level",
          },
          {
            id: "loi-3",
            lab_order_id: orderId,
            ...
            unit: "mg/dL",
            is_abnormal: true,
            remarks: "Borderline elevated; dietary modification recommended",
          },
          {
            id: "loi-4",
            lab_order_id: orderId,
          ...
          },
          {
            ...
            unit: "mg/dL",
            is_abnormal: false,
            remarks: "Normal fasting euglycemia",
          },
        ]);
      } finally {
        setLoading(false);
                ...
                {items.map((item, idx) => (
                  <tr key={idx} className="hover:bg-slate-50/60">
                    ...
                    <td className="py-3 font-bold">
                      <span
                        className={
                          item.is_abnormal ? "text-rose-600 font-extrabold" : "text-slate-900"
                        }
                      >
                        {item.result_value}
                      </span>
                    ...
                    <td className="py-3 text-xs">
                      {item.is_abnormal ? (
                        <span className="inline-flex items-center gap-1 text-rose-700 bg-rose-50 px-2 py-0.5 rounded font-semibold text-[11px] border border-rose-100">
                          ...
                          <span>Abnormal ({item.remarks})</span>
                        </span>
                      ) : (
