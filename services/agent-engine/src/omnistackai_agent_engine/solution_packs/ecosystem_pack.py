...
from .ecosystem_docs import EcosystemDocsContract, synthesize_ecosystem_docs
...
class EcosystemPackPackage:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if self.alerting_contract is not None:
        ...
        if self.docs_contract is not None:
            data["docs_contract"] = self.docs_contract.to_dict()
        return data
...
def parse_ecosystem_pack_package(data: str | bytes | Mapping[str, Any]) -> EcosystemPackPackage:
    ...
    if "alerting_contract" in raw and raw["alerting_contract"] is not None:
        alerting_contract = EcosystemAlertingContract.from_dict(raw["alerting_contract"])
    ...
    docs_contract = None
    if "docs_contract" in raw and raw["docs_contract"] is not None:
        docs_contract = EcosystemDocsContract.from_dict(raw["docs_contract"])
...
def synthesize_ecosystem_pack(
    ...
    *,
    ...
    alerting_contract = synthesize_ecosystem_alerting(
        ecosystem_id,
        surface_packages,
        version=version,
    )
    ...
    payload = {
        ...
        "docs_contract": docs_contract.to_dict(),
    }
