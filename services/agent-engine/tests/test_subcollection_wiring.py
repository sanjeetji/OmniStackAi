...
class FilteredRepositoryEmissionTests(TestCase):
    ...
    def test_go_store_has_filtered_list(self) -> None:
        ...
        self.assertIn("func ListCommentByPost(ctx context.Context, db *sql.DB, postID string, limit int)", content)
...
class SubcollectionWiringTests(TestCase):
    ...
    def test_go_handler_calls_filtered_store(self) -> None:
        ...
        self.assertIn('store.ListCommentByPost(r.Context(), h.DB, r.PathValue("postId"), 100)', handlers)
