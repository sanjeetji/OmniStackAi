...
' "$service_root/pyproject.toml"
  ...
  solution-pack-ecosystem)
    # Synthesize, verify, inspect, build, catalog, auth, or state for ecosystem packs (no model/network).
    configure_python
