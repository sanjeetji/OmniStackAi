...
' "$service_root/pyproject.toml"
  ...
  solution-pack-ecosystem)
    # Synthesize, verify, inspect, build, catalog, auth, state, events, telemetry, or deploy for ecosystem packs (no model/network).
    configure_python
