...
' "$service_root/pyproject.toml"
  ...
  solution-pack-ecosystem)
    # Synthesize, verify, inspect, or build multi-surface ecosystem packs (no model/network).
    configure_python
