# OmniStackAI — implementation progress (as of R-349)
...
|-------|------|-------|-----------|
| **MVP** (current milestone) | 138 | 244 | **56.6%** |
| MID | 0 | 47 | 0% |
| ADVANCED | 0 | 29 | 0% |
| PRODUCTION | 0 | 29 | 0% |
| **Overall program** | **138** | **349** | **39.5%** |
