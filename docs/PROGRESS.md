# OmniStackAI — implementation progress (as of R-355)
...
|-------|------|-------|-----------|
| **MVP** (current milestone) | 144 | 250 | **57.6%** |
| MID | 0 | 47 | 0% |
| ADVANCED | 0 | 29 | 0% |
| PRODUCTION | 0 | 29 | 0% |
| **Overall program** | **144** | **355** | **40.6%** |
