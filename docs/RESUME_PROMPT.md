...
WHAT IS ALREADY BUILT (platform generators are Python 3.13 stdlib-only, offline, in services/agent-engine; 1,567 tests pass)
...
WHAT TO DO NEXT (pick with the founder; all continue the builder), continue from R-350
...
(R-350) with its task contract before writing code.
