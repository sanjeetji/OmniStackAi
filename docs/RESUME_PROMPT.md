...
WHAT TO DO NEXT
- LATEST (2026-09-21): R-520 (T-2 multi-app preview) is done; see .ai/tasks/R-520.md. Next: R-521
  (generated toast.tsx syntax error breaking prompt-built apps), then T-3 marketplace UI.
