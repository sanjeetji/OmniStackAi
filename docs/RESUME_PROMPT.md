...
WHAT TO DO NEXT
- LATEST (2026-09-22): R-526 (RideNow part 1/4: API/DB/seed) is done; the master plan is in
  .ai/tasks/R-526.md. Next: R-527 rider web app, R-528 driver PWA, R-529 admin + publish.
